...
namespace GE2AutomatedTesting.UnitTests
{
    ...
    public class Tests
    {
        ...
        [DataSource(@"System.Data.Odbc", @"Dsn=Excel Files;dbq=TestData.xlsx;defaultdir=C:\Users\Rahul\source\repos\C#SeleniumFramework\TestData\; driverid=790;maxbuffersize=2048;pagetimeout=5", "Login$", DataAccessMethod.Sequential)]
        [TestMethod]
        public void Test1()
        {
